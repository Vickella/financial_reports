frappe.query_reports["IFRS 18 Cost Center Profitability"] = $.extend({}, erpnext.financial_statements);
erpnext.utils.add_dimensions("IFRS 18 Cost Center Profitability", 10);
frappe.query_reports["IFRS 18 Cost Center Profitability"].filters.push(
