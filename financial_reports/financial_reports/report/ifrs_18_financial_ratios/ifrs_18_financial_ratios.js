frappe.query_reports["IFRS 18 Financial Ratios"] = $.extend({}, erpnext.financial_statements);
erpnext.utils.add_dimensions("IFRS 18 Financial Ratios", 10);
frappe.query_reports["IFRS 18 Financial Ratios"].filters.push(
...
financial_reports.apply_accounting_formatter("IFRS 18 Financial Ratios");
