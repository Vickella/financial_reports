frappe.query_reports["IFRS 18 Working Capital Analysis"] = $.extend({}, erpnext.financial_statements);
erpnext.utils.add_dimensions("IFRS 18 Working Capital Analysis", 10);
frappe.query_reports["IFRS 18 Working Capital Analysis"].filters.push(
